...
| E4 | **bagholder-bounce v1** | quant-strategist | 🧪 CODIFIED / PRE-REGISTERED — ≥20% gap-down + ≥5% opening flush + first higher-low/high-reclaim, 09:45–11:00 ET, 2R, long-only; fixed 11-name real Alpaca-IEX sleeve and unchanged participation/risk/cash envelope. It differs from seven rejected intraday parents by requiring both discontinuous repricing and sequential seller exhaustion. 1Y then one FULL; seed 42; no tuning. |
