...
1. **R3-1 momentum-v3 — DONE / REJECTED:** the true shared-book run passed its frozen 3×3 plateau but
   ...
   Next implement R3-2 dual-momentum rotation without retuning v3.
...
| R3-1 | **momentum-v3 — ✅ DONE / REJECTED** | Promotion-grade shared-book run (`f9d788b`, seed 42): 1,637 trades; full/OOS CAGR 5.74%/11.83%; DSR(9) 0.414/0.375; MC book-day p95 DD 49.91%; plateau PASS; max six holdings; 0 MOCK. Ordered reasons: `DSR_FAILURE`, `DRAWDOWN_RISK_FAILURE`, `SHARIA_UNVERIFIABLE`. No AUTO_PAPER admission; next R3-2. |
