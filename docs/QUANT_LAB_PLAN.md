...
| E5 | **time-of-day v1** | quant-strategist | 🧪 CODIFIED / PRE-REGISTERED LAST — A: ≥1% opening drop then first higher-low reclaim, 09:45–10:00; B: first-hour return ≥1% then first high/VWAP breakout, 10:30–11:00; 2R, long-only. Clock windows are constraints/A-B overlay against the rejected lane, not a time sweep; fixed 11-name real Alpaca-IEX sleeve, seed 42, 1Y then one FULL, no tuning. |
