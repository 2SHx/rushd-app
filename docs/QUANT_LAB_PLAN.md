...
| M17 broker-neutral shadow-paper proof | backend-expert + security-auditor | 🔄 PREFLIGHT BUILT / MUTATION BLOCKED | DR-11 + QDR-8 operational mirror: InternalSim remains authoritative; external paper probes are capped operational evidence only. Alpaca first because the adapter and free IEX paper feed already exist; execution selection is independent of market-data mode. Read-only live preflight on 2026-08-16 found cash −$82,800.08, buying power $0, 6 unreconciled positions including a short, and 0 open orders, so submit/flatten/scheduling stay blocked pending a clean dedicated paper account or separately authorized legacy cleanup plus all M17 security gates. |
