...
1. **G3e portfolio truth prerequisite — DONE:** the DB-free shared-cash daily strategy-book engine now
   emits true Decimal NAV/drawdown and is explicitly routable without changing legacy artifacts. R3-1 may
   now validate its basket governor through this substrate; persistence remains a later scoped unit.
