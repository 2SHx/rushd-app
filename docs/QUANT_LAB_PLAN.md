...
| R4-E1 momentum v4 | quant-strategist | 🧪 CODIFIED / PRE-REGISTERED | v3 signal/volatility/plateau layers unchanged; frozen 8%-to-20% drawdown de-risking and C1 verified sleeve await the 1Y diagnostic then one FULL verdict. |
