...
Open: G8 shipped at `165607c` against the pre-correction text — follow-up owed: floor 156→104, delete the (c1) gate and `'CAPTURE_CONVEXITY'`, add printed-captures-with-disclaimer, half-window and lower-bound `volFloor` tests. First honest BETA verdict now ≈2 years (n=104), a ~7× gain on 14.72y; the earlier 3–4y figure was wrong and the 1–2y figure was right for the wrong reason.
