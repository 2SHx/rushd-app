...
export default async function AcademyPracticePage({
  ...
  searchParams?: { topic?: string | string[]; apply?: string | string[] };
}) {
  ...
  const applySetupId = typeof searchParams?.apply === 'string' && searchParams.apply.length > 0 ? searchParams.apply : null;
