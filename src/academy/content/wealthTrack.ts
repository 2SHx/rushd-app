  ...
  units: [
    ...
    },
    {
      ...
      lessons: [
        ...
        {
          id: 'sukuk-vs-bonds-teens',
          title: { en: 'Sukuk vs. Conventional Bonds', ar: 'الصكوك الإسلامية مقابل السندات: الفروق الجوهرية' },
          summary: {
            en: 'Understand why Sukuk represent asset ownership while bonds represent interest-bearing debt.',
            ar: 'فهم كيف تمثل الصكوك ملكية في أصول حقيقية بينما السندات التقليدية تمثل ديوناً بفائدة.',
          },
          body: {
            en: "Conventional bonds are pure loan contracts where the issuer pays guaranteed interest (Riba). In contrast, Sukuk are trust certificates representing undivided partial ownership in tangible assets, projects, or usufructs. Sukuk holders earn a share of revenue generated by the underlying real asset, making Sukuk an ethical, asset-backed investment vehicle.",
            ar: 'السندات التقليدية هي عقود إقراض بحتة يدفع فيها المصدر فوائد محددة سلفاً (ربا محرم). في المقابل، الصكوك هي شهادات ملكية تمثل حصة شائعة في ملكية أصول حقيقية أو مشاريع أو منافع قائمة. يحصل حملة الصكوك على حصة من الأرباح الفعلية المستفادة من الأصل، مما يمتلك غطاءً عينياً وحلالاً.',
          },
          complianceTag: 'EDUCATIONAL_ONLY',
          ageSegment: 'TEENS',
          contentVersion: 1,
          checkpoint: {
            id: 'sukuk-vs-bonds-teens-cp1',
            question: {
              en: 'What do Sukuk represent compared to conventional bonds?',
              ar: 'ماذا تمثل الصكوك الإسلامية مقارنة بالسندات التقليدية؟',
            },
            options: [
              { en: 'Undivided ownership in real tangible assets or projects', ar: 'ملكية شائعة في أصول حقيقية أو منافع ومشاريع' },
              { en: 'Pure interest-bearing cash debt', ar: 'ديون نقدية بحتة قائمة على الفوائد' },
              { en: 'Lottery tickets with random yields', ar: 'تذاكر يانصيب بعوائد عشوائية' },
              { en: 'High-risk leveraged margin loans', ar: 'قروض بالهامش عالية المخاطر' },
            ],
            correctOptionIndex: 0,
            explanation: {
              en: 'Sukuk convey ownership in real assets and profit sharing, conforming to Sharia principles.',
              ar: 'تمنح الصكوك ملكية في أصول حقيقية وتقاسماً للأرباح بما يتوافق مع الضوابط الشرعية.',
            },
            complianceTag: 'EDUCATIONAL_ONLY',
          },
        },
        {
          id: 'risk-parity-rebalancing-adults',
          title: { en: 'Periodic Rebalancing & Risk Envelope Discipline', ar: 'إعادة التوازن الدوري وانضباط ضوابط المخاطر' },
          summary: {
            en: 'Maintain intended asset weights over long investment horizons.',
            ar: 'الحفاظ على الأوزان المستهدفة للأصول عبر الدورات الاقتصادية المختلفة.',
          },
          body: {
            en: "As market prices fluctuate, a 60/40 Equity/Sukuk portfolio can drift to 75/25 during a prolonged bull market, exposing the investor to higher drawdown risk than intended. Rebalancing involves systematically selling a portion of appreciated assets and buying underweight assets to reset to baseline target weights annually.",
            ar: 'مع تقلب أسعار السوق، قد تتغير محفظتك المتوازنة بنسبة 60/40 (أسهم/صكوك) لتصبح 75/25 أثناء الصعود القوي، مما يعرضك لمخاطر هبوط أعلى من المستهدف. إعادة التوازن الدوري تتطلب بيع جزء من الأصول المرتفعة وشراء الأصول الأقل وزناً لإعادتها إلى النسب المستهدفة سنوياً.',
          },
          complianceTag: 'EDUCATIONAL_ONLY',
          ageSegment: 'ADULTS',
          contentVersion: 1,
          checkpoint: {
            id: 'risk-parity-rebalancing-adults-cp1',
            question: {
              en: 'What is the primary objective of portfolio rebalancing?',
              ar: 'ما هو الهدف الرئيسي من إعادة التوازن الدوري للمحفظة؟',
            },
            options: [
              { en: 'To reset asset weights to target risk envelopes', ar: 'إعادة أوزان الأصول إلى المستويات والمخاطر المستهدفة' },
              { en: 'To double short-term leverage', ar: 'مضاعفة الرافعة المالية قصيرة الأجل' },
              { en: 'To trade as frequently as possible every hour', ar: 'التداول كل ساعة بصفقات مكثفة' },
              { en: 'To liquidate all investments to cash', ar: 'تسييل جميع الاستثمارات إلى نقد فوراً' },
            ],
            correctOptionIndex: 0,
            explanation: {
              en: 'Rebalancing controls portfolio drift and prevents unmanaged risk concentration.',
              ar: 'إعادة التوازن تضبط انحراف المحفظة وتمنع تركز المخاطر غير المحسوبة.',
            },
            complianceTag: 'EDUCATIONAL_ONLY',
          },
        },
